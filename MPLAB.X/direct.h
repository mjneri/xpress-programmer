...
#if !defined(DRV__MAX_NUM_FILES_IN_ROOT)
#define DRV__MAX_NUM_FILES_IN_ROOT 16
#endif
...
#define DRV_NUM_ROOT_DIRECTORY_SECTORS ((DRV__MAX_NUM_FILES_IN_ROOT+15)/16) //+15 because the compiler truncates
#define DRV_OVERHEAD_SECTORS (\
            DRV_NUM_RESERVED_SECTORS + \
            DRV_NUM_VBR_SECTORS + \
            DRV_NUM_ROOT_DIRECTORY_SECTORS + \
            DRV_NUM_FAT_SECTORS)
...
#if (DRV__MAX_NUM_FILES_IN_ROOT != 16) && \
    (DRV__MAX_NUM_FILES_IN_ROOT != 32) && \
    (DRV__MAX_NUM_FILES_IN_ROOT != 48) && \
    (DRV__MAX_NUM_FILES_IN_ROOT != 64)
